...
class GildedRoseTest(unittest.TestCase):
    def test_update_quality_aged_brie(self):
        ...
        # Ensure Aged Brie quality increases and sell_in decreases
    ...
    def test_update_quality_sulfuras(self):
        ...
        # Ensure Sulfuras quality and sell_in remain unchanged
        gilded_rose.update_quality()
    ...
    def test_update_quality_conjured(self):
        ...
        # Conjured item - quality becomes negative
